...
export const research = [
  {
    title: "Minimum Wage Policy Impact",
    tagline: "Causal Inference & Econometrics",
    tags: ["Difference-in-Differences", "Causal Inference", "Policy Analysis"],
...
export const skillCategories = [
  {
    ...
    color: "green",
    skills: ['SQL (Advanced)', 'Python', 'ETL/Pipeline Design', 'Data Modeling', 'Spark', 'Hadoop', 'Airflow', 'dbt', 'Azure Data Factory', 'AWS (S3, Redshift)', 'Data Governance']
  },
  {
    title: "Visualization & Business Intelligence",
    color: "blue",
    skills: ['Tableau', 'Power BI', 'D3.js', 'Excel', 'Data Storytelling', 'Dashboards', 'Strategic Analytics']
  },
  {
